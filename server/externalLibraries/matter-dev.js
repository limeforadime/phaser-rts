...
*/
          ...
          (function() {
            ...
            Body.update = function(body, deltaTime, timeScale, correction) {
              ...
              body.velocity.x =
                velocityPrevX * frictionAir * correction + (body.force.x / body.mass) * deltaTimeSquared;
              body.velocity.y =
                velocityPrevY * frictionAir * correction + (body.force.y / body.mass) * deltaTimeSquared;
              ...
              for (i = 0; i < collisions.length; i++) {
                ...
                if (collision.collided) {
                  ...
                  if (pair) {
                    ...
                    // push the new pair
                    collisionStart.push(pair);
                    pair.bodyA.onCollision(pair.bodyB);
                    pair.bodyB.onCollision(pair.bodyA);
                    pairsList.push(pair);
                  }
                }
              }
        ...
        function(require, module, exports) {
          ...
          (function() {
            ...
            Composites.pyramid = function(xx, yy, columns, rows, columnGap, rowGap, callback) {
              return Composites.stack(xx, yy, columns, rows, columnGap, rowGap, function(
                x,
                y,
                column,
                row,
